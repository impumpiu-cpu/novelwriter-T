...
// Русский каталог базовых сообщений интерфейса (настройки, навигация,
// вход, библиотека, время, LLM-конфигурация, обратная связь).
const ruMessages: Partial<Record<UiMessageKey, UiMessageValue>> = {
  'settings.title': 'Настройки',
  'settings.section.appearance': 'Внешний вид',
  'settings.section.ai': 'Настройка модели ИИ',
  'settings.section.account': 'Аккаунт',
  'settings.footer.version': APP_VERSION_LABEL,
  'settings.appearance.themeTitle': 'Тема оформления',
  'settings.appearance.theme.dark': 'Тёмная тема',
  'settings.appearance.theme.light': 'Светлая тема',
  'settings.appearance.languageTitle': 'Язык интерфейса',
  'settings.appearance.languageDescription': 'Выберите язык отображения для поддерживаемых разделов продукта.',
  'settings.appearance.language.ru': 'Русский',
  'settings.appearance.language.zh': '简体中文',
  'settings.appearance.language.en': 'English',
  'settings.account.nickname': 'Никнейм',
  'settings.account.remainingQuota': 'Оставшиеся генерации',
  'settings.account.feedbackReward': 'Отправьте отзыв, чтобы получить дополнительную квоту генераций',
  'settings.account.submitFeedback': 'Отправить отзыв',
  'settings.account.logout': 'Выйти',

  'navbar.features': 'Возможности',
  'navbar.library': 'Библиотека',
  'navbar.settings': 'Настройки',
  'navbar.login': 'Войти',
  'footer.link.terms': 'Правила использования',
  'footer.link.privacy': 'Конфиденциальность',
  'footer.link.copyright': 'Жалобы на авторские права',
  'footer.description': 'Инструмент для написания и продолжения длинных романов с помощью ИИ. Перед использованием сервиса ознакомьтесь с правилами, политикой конфиденциальности и порядком подачи жалоб на нарушение авторских прав.',
  'dialog.confirm': 'Подтвердить',
  'dialog.cancel': 'Отмена',
  'dialog.gotIt': 'Понятно',
  'plainText.loading': 'Загрузка...',
  'plainText.empty': 'Пока нет содержимого',

  'login.header.hosted': 'При первом входе активируйте аккаунт по инвайт-коду; далее входите по никнейму, паролю или через GitHub',
  'login.header.hostedInviteOnly': 'При первом входе активируйте аккаунт по инвайт-коду; далее входите по никнейму и паролю',
  'login.header.selfhost': 'Войдите в свой аккаунт',
  'login.oauth.disabled': 'Вход через GitHub пока недоступен в этой бета-версии.',
  'login.oauth.githubNotConfigured': 'Вход через GitHub ещё не настроен. Попробуйте позже.',
  'login.oauth.stateInvalid': 'Сессия входа устарела. Нажмите «Войти через GitHub» ещё раз.',
  'login.oauth.accessDenied': 'Вы отменили авторизацию GitHub, вход не выполнен.',
  'login.oauth.signupBlocked': 'Регистрация новых аккаунтов через GitHub приостановлена. Попробуйте позже.',
  'login.oauth.accountDisabled': 'Этот аккаунт отключён. Обратитесь к администратору.',
  'login.oauth.failed': 'Не удалось войти через GitHub. Попробуйте позже.',
  'login.github.button': 'Войти через GitHub',
  'login.invite.or': 'или другим способом',
  'login.invite.code.label': 'Инвайт-код',
  'login.invite.code.placeholder': 'Введите ваш персональный инвайт-код (только для первой активации)',
  'login.invite.nickname.label': 'Никнейм',
  'login.invite.nickname.placeholder': 'Отображаемое имя при первом входе',
  'login.hosted.mode.login': 'Вход',
  'login.hosted.mode.activate': 'Первая активация',
  'login.hosted.loginHint': 'Если аккаунт уже активирован, войдите по никнейму и паролю.',
  'login.hosted.activateHint': 'Инвайт-код нужен только для первой активации. После неё входите по никнейму и паролю.',
  'login.hosted.nickname.placeholder': 'Введите никнейм, указанный при активации',
  'login.hosted.password.activatePlaceholder': 'Задайте пароль для последующих входов',
  'login.hosted.password.loginPlaceholder': 'Введите пароль',
  'login.hosted.password.hint': 'Не менее 8 символов. После активации вход выполняется по никнейму и паролю.',
  'login.hosted.password.minLengthError': 'Пароль должен содержать не менее 8 символов.',
  'login.hosted.nickname.requiredError': 'Сначала укажите никнейм.',
  'login.hosted.invite.requiredError': 'Сначала введите инвайт-код.',
  'login.hosted.activation.genericError': 'Активация не удалась. Проверьте введённые данные и попробуйте снова.',
  'login.hosted.activation.networkError': 'Не удалось подключиться к серверу. Убедитесь, что сервис запущен, и попробуйте снова.',
  'login.username.label': 'Имя пользователя',
  'login.password.label': 'Пароль',
  'login.submit.loading': 'Подождите...',
  'login.submit.activate': 'Активировать и войти',
  'login.submit.hostedLogin': 'Войти',
  'login.submit.selfhost': 'Войти',
  'login.requestIdSuffix': ({ requestId }) => ` (Request ID: ${String(requestId ?? '')})`,
  'login.alert.invalidInvite.title': 'Недействительный инвайт-код',
  'login.alert.invalidInvite.description': 'Проверьте правильность инвайт-кода',
  'login.alert.inviteClaimed.title': 'Инвайт-код уже активирован',
  'login.alert.inviteClaimed.description': 'Этот инвайт-код уже использован для первой активации. Войдите по никнейму и паролю.',
  'login.alert.nicknameTaken.title': 'Никнейм занят',
  'login.alert.nicknameTaken.description': 'Этот никнейм уже используется другим аккаунтом. Выберите другой и повторите активацию.',
  'login.alert.signupBlocked.title': 'Регистрация приостановлена',
  'login.alert.signupBlocked.description': 'Новые регистрации временно недоступны. Попробуйте позже',
  'login.alert.invalidCredentials.title': 'Не удалось войти',
  'login.alert.invalidCredentials.description': 'Неверный никнейм или пароль',
  'login.alert.backend404.title': 'Ошибка подключения',
  'login.alert.backend404.description': 'Не удалось подключиться к серверу (/api вернул 404). Если вы разрабатываете в WSL с браузером в Windows, убедитесь, что бэкенд запущен, и перезапустите dev-сервер фронтенда, чтобы заработал Vite-прокси /api.',
  'login.alert.httpFailure.title': 'Ошибка запроса',
  'login.alert.httpFailure.description': ({ status }) => `Запрос не выполнен (HTTP ${String(status ?? '')}). Попробуйте позже`,
  'login.alert.network.title': 'Ошибка подключения',
  'login.alert.network.description': 'Не удалось подключиться к серверу. Убедитесь, что бэкенд запущен и фронтенд использует прокси /api.',

  'library.create': 'Новое произведение',
  'library.title': 'Моя библиотека',
  'library.description': 'Управляйте всеми своими романами',
  'library.demo.badge': 'Обучающий пример',
  'library.demo.title': 'Сначала попробуйте пример, затем импортируйте свой текст',
  'library.demo.description': ({ title }) => `Откройте пример «${String(title ?? '')}», чтобы быстро понять, как вместе работают модель мира, продолжение в Studio и поиск по всей книге.`,
  'library.demo.description.inProgress': ({ title, current, total }) => `Обучающий пример «${String(title ?? '')}» пройден на ${String(current ?? 0)}/${String(total ?? 4)} шагов. Вернитесь в Studio и завершите знакомство с моделью мира, продолжением и Copilot.`,
  'library.demo.description.completed': ({ title }) => `Вы уже прошли обучающий пример «${String(title ?? '')}». Можно вернуться к нему в любой момент или загрузить собственный текст.`,
  'library.demo.description.skipped': ({ title }) => `Вы скрыли обучающий пример «${String(title ?? '')}». Его можно открыть снова в любой момент или сразу загрузить собственный текст.`,
  'library.demo.open': 'Открыть пример',
  'library.demo.start': 'Начать обучение',
  'library.demo.resume': 'Продолжить обучение',
  'library.demo.reopen': 'Посмотреть снова',
  'library.demo.upload': 'Загрузить мой .txt',
  'library.error.load': 'Не удалось загрузить',
  'library.error.unknown': 'Неизвестная ошибка',
  'library.error.uploadFailed': 'Не удалось загрузить файл',
  'library.error.uploadTooLarge': ({ maxMb }) => `Файл слишком большой. Загрузите текстовый файл .txt размером не более ${String(maxMb ?? 30)} МБ`,
  'library.error.uploadTypeNotSupported': 'Поддерживаются только текстовые файлы .txt',
  'library.error.uploadParseFailed': 'Файл загружен, но его пока не удалось разобрать. Убедитесь, что заголовки глав оформлены чётко, и попробуйте снова.',
  'library.uploadOverlay.title': 'Загружаем роман',
  'library.uploadOverlay.description': 'Подождите. После завершения загрузки NovWr импортирует главы и автоматически подготовит данные о мире.',
  'library.confirm.delete': 'Удалить это произведение? Действие нельзя отменить.',
  'library.empty.title': 'Пока нет произведений — начните писать свой первый роман',
  'library.workCard.meta': ({ chapterCount, relativeTime }) => `Глав: ${String(chapterCount ?? 0)} · обновлено ${String(relativeTime ?? '')}`,
  'library.workCard.delete': 'Удалить',

  'time.justNow': 'только что',
  'time.minutesAgo': ({ count }) => `${String(count ?? 0)} мин назад`,
  'time.hoursAgo': ({ count }) => `${String(count ?? 0)} ч назад`,
  'time.yesterday': 'вчера',
  'time.daysAgo': ({ count }) => `${String(count ?? 0)} дн. назад`,
  'time.weeksAgo': ({ count }) => `${String(count ?? 0)} нед. назад`,
  'time.monthsAgo': ({ count }) => `${String(count ?? 0)} мес. назад`,

  'llm.notice.hosted': 'В hosted-бете используются только учётные данные ИИ, управляемые платформой; переопределение BYOK на стороне браузера не принимается. Продолжение, генерация мира, bootstrap и фоновые задачи используют одну и ту же конфигурацию платформы. Если нужен собственный ключ модели, разверните сервис самостоятельно через Docker или переменные окружения.',
  'llm.notice.selfhost': 'В целях безопасности эта конфигурация хранится только в памяти текущей вкладки браузера и очищается при обновлении страницы. Для постоянного использования собственного ключа рекомендуем самостоятельное развёртывание через Docker или переменные окружения.',
  'llm.warning.partialConfig': 'Заполнена только часть конфигурации BYOK. Укажите одновременно Base URL, API Key и Model, иначе продолжение, генерация мира и извлечение будут отклонены.',
  'llm.error.incompleteConfig': 'Текущая конфигурация BYOK неполна. Заполните Base URL, API Key и Model вместе или очистите конфигурацию.',
  'llm.error.aiDisabled': 'На этом экземпляре функции ИИ отключены, запросы к модели временно недоступны.',
  'llm.error.budgetHardStop': 'Квота управляемого ИИ на этом экземпляре исчерпана. Попробуйте позже или используйте собственный API-ключ.',
  'llm.error.budgetUnavailable': 'Запросы к управляемому ИИ на этом экземпляре временно закрыты. Попробуйте позже или используйте собственный API-ключ.',
  'llm.error.modelUnavailable': 'Текущая модель недоступна. Проверьте соответствие Base URL, API Key и Model и убедитесь, что интерфейс поддерживает режим JSON.',
  'llm.result.successFallback': ({ latencyMs }) => `Проверка подключения и совместимости пройдена (${String(latencyMs ?? '')} мс)`,
  'llm.result.connectionFailed': 'Ошибка подключения',
  'llm.result.httpFailed': ({ status }) => `Запрос не выполнен (HTTP ${String(status ?? '')})`,
  'llm.label.baseUrl': 'API Base URL',
  'llm.label.apiKey': 'API Key',
  'llm.label.model': 'Название модели',
  'llm.button.testing': 'Проверка...',
  'llm.button.test': 'Проверить подключение',
  'llm.button.clear': 'Очистить конфигурацию этой вкладки',

  'feedback.title': 'Обратная связь',
  'feedback.description': 'Заполните форму ниже, чтобы получить дополнительную квоту генераций. Ваш отзыв очень важен для нас.',
  'feedback.question.rating': '1. Как вам общее впечатление?',
  'feedback.question.issues': '2. С какими проблемами вы столкнулись? (можно выбрать несколько)',
  'feedback.question.suggestion': '3. Предложения по улучшению (необязательно)',
  'feedback.rating.great': 'Отлично, превзошло ожидания',
  'feedback.rating.good': 'Неплохо, есть потенциал',
  'feedback.rating.okay': 'Средне, нужно дорабатывать',
  'feedback.rating.poor': 'Слабо, много проблем',
  'feedback.issue.speed': 'Слишком медленная генерация',
  'feedback.issue.quality': 'Недостаточное качество текста',
  'feedback.issue.ux': 'Неинтуитивный рабочий процесс',
  'feedback.issue.bugs': 'Столкнулся с багом',
  'feedback.issue.other': 'Другая проблема',
  'feedback.issue.none': 'Пока без заметных проблем',
  'feedback.placeholder.bug': 'Кратко опишите баг, например: после загрузки романа страница стала пустой',
  'feedback.placeholder.other': 'Что именно пошло не так?',
  'feedback.placeholder.suggestion': 'Есть идеи или предложения?',
  'feedback.bonus.max': 'Отправьте отзыв и получите 30 генераций',
  'feedback.bonus.upgrade': 'Напишите предложение длиной от 20 символов, чтобы увеличить бонус с 20 до 30 генераций',
  'feedback.submit.loading': 'Отправка...',
  'feedback.submit.button': ({ count }) => `Отправить отзыв и получить ${String(count ?? 20)} генераций`,
}
