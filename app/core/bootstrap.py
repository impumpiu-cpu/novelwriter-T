...
"""Bootstrap: автоматическое извлечение модели мира из глав.

Этапы конвейера: токенизация текста → извлечение кандидатов (имена, места,
фракции) → оконный анализ совместной встречаемости по главам → уточнение
кандидатов через LLM → сохранение результатов как черновиков мира на проверку.
"""
